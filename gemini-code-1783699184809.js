...
function runIntroSequence() {
  // Scena 1 (0-1s) visibile di default
...
function startGame() {
  ...
  faceSprite.src = "assets/faccia-0.png";
...
function handleSlap(e) {
  ...
  // Cambia immagine solo se il livello è scattato
  if (newLevel !== level) {
    level = newLevel;
    faceSprite.src = `assets/faccia-${level}.png`;
  }
...
function endGame() {
  ...
  finalFaceSprite.src = `assets/faccia-${level}.png`;
